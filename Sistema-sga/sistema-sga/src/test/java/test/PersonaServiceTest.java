...
public class PersonaServiceTest {
	...
	public void setUp() throws Exception{
		...
		personaService = (PersonaService) contenedor.getContext().lookup("java:global/classes/PersonaServiceImpl!com.johnarias.sga.servicio.PersonaService");
	}
	...
	public void testEJBPersonaService(){
		...
		System.out.println("El numero de personas es " + personaService.listarPersonas().size());
		
		this.desplegarPersonas(personaService.listarPersonas());
		System.out.println("Fin de Test EJB PersonaService");
	}
